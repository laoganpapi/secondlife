...
TEXMAP = {
    ...
    "RobeUpper": ("robe_upper.png", 0.85, 0.0, {"normal": "robe_normal.png"}),
    "RobeLower": ("robe_lower.png", 0.85, 0.0, {"normal": "robe_normal.png"}),
    "Sash": ("sash.png", 0.35, 0.0, {"normal": "sash_normal.png"}),
    "Pants": ("pants.png", 0.85, 0.0, {"normal": "pants_normal.png"}),
